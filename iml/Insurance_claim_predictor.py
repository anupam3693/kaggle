...
# Load the data
data = pd.read_csv('/Users/anupam7936/afb/kaggle-30-days-of-ml/train.csv', index_col='id')
X_test = pd.read_csv('/Users/anupam7936/afb/kaggle-30-days-of-ml/test.csv', index_col='id')
...
output = pd.DataFrame({'id': X_test.index,
                       'target': preds_test})
output.to_csv('/Users/anupam7936/afb/kaggle-30-days-of-ml/submission.csv', index=False)
